### Como pedido na atividade, a base de dados escolhida foi uma sobre Nutrição de alimentos assados ​​ela tem como objetivo saber se você está se alimentando de forma saudável.
